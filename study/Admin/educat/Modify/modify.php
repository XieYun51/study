...
<html>
	...
	<body>
		...
		<form class="layui-form" method="post" action="deaMody.php">		
  ...
  <div class="layui-form-item">
    ...
    <div class="layui-input-inline">
      <input type="text" name="brief"  required lay-verify="required" placeholder="请输入系部简称" class="layui-input">
    </div>
    
  </div>
  <input type="hidden" name="codes"  value="<?php echo $_GET['id']; ?>" />
