			...
			<div class="main-left-side">
				...
				<ul class="layui-nav layui-nav-tree" lay-filter="leftNav">
				  ...
				  <li class="layui-nav-item  layui-nav-itemed">
				   ...
				   <li class="layui-nav-item  layui-nav-itemed">
				  	<a href="javascript:;"><i class="icons layui-icon layui-icon-auz"></i>用户权限管理</a>
				  	<dl class="layui-nav-child">
				      <dd>
				      	<a href="Add/createUser.php" class="sub0">
				      		<span class="icons layui-icon layui-icon-user">
				      		</span>添加用户
				      	</a>
				      </dd>
				      <dd>
				      	<a href="Auth/userShow.php" class="sub0">
				      		<span class="icons layui-icon layui-icon-set-fill">
				      		</span>权限设置
				      	</a>
				      </dd>
				   </dl>
				...
				<div class="main-header"><!--头部开始-->
					...
					<ul class="layui-nav" lay-filter="rightNav">
					  <li class="layui-nav-item cool">
					    <a href="javascript:;"><?php echo select_name("off_admin","admin_name","admin_code='{$_SESSION['num']}'");?>老师</a>
					  </li>
