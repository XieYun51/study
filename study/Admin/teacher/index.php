				...
				<div class="main-header"><!--头部开始-->
					...
					<ul class="layui-nav" lay-filter="rightNav">
					  <li class="layui-nav-item cool">
					    <a href="javascript:;"><?php echo select_name("off_teacher","tea_name","tea_code='{$_SESSION['num']}'");?>老师</a>
					  </li>
					  <li class="layui-nav-item">
				...
				<div class="main-middle-body">
					...
					<div class="layui-tab layui-tab-brief" lay-filter="tab">
					  <ul class="layui-tab-title">
					    <li class="layui-this info">教师主页</li>
					  </ul>
					  <div class="layui-tab-content">
					    <div class="layui-tab-item layui-show" >
					    	
					    	<iframe id="skip" src="pwd.php" width="100%" height="600px" name="iframe" scrolling="auto" class="iframe"  frameborder="no"></iframe>
