			...
			<div class="main-left-side">
				...
				<ul class="layui-nav layui-nav-tree" lay-filter="leftNav">
				  ...
				  <li class="layui-nav-item">
				    <a href="look_stuInfo.php" class="sub0">
				    	<i class="icons layui-icon layui-icon-notice"></i>
				    	查询学生信息
				    </a>
				  </li>
				  
				  <li class="layui-nav-item">
				    <a href="lookScore.php" class="sub0">
				...
				<div class="main-header"><!--头部开始-->
					...
					<ul class="layui-nav" lay-filter="rightNav">
					  <li class="layui-nav-item cool">
					    <a href="javascript:;"><?php echo select_name("off_assist","ass_name","ass_code='{$_SESSION['num']}'");?>老师</a>
					  </li>
					  <li class="layui-nav-item">
				...
				<div class="main-middle-body">
					...
					<div class="layui-tab layui-tab-brief" lay-filter="tab">
					  <ul class="layui-tab-title">
					    <li class="layui-this info">辅导员主页</li>
					  </ul>
					  <div class="layui-tab-content">
					    <div class="layui-tab-item layui-show" >
					    	
					    	<iframe id="skip" src="look_stuInfo.php" width="100%" height="600px" name="iframe" scrolling="auto" class="iframe"  frameborder="no"></iframe>
